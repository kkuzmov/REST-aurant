...
class HomepageGuest extends Component{
    ...
    render(){
        return (
    <main>
        <h1 class="welcome">Welcome to REST-aurant!</h1>
        <p class="lorem-ipsum">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Perspiciatis alias ullam repudiandae quos voluptatum debitis vero dicta error soluta perferendis et eveniet quidem, aliquid quas assumenda non? Eligendi, sit voluptatum.</p>
        <article class="all-rated-restaurants">
            <article class="restaurant-card card-left-guest">
